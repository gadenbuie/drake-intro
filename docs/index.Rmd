...
.f2.moffitt-bg-light-blue-o90.white.pa5.strong[
...
background-image: url(https://ropensci.github.io/drake/figures/infographic.svg)
background-size: 100%
...
.f1.mt4.pa4.code[
verb <- .dark-gray[function(].moffitt-bg-blue.moffitt-blue.pa3.o-0[x, y = 0, ...]) {  
.moffitt-bg-green.moffitt-green.mh3.pv1.ph4[
x_range <- max(x) - min(x)
...
.moffitt-bg-green.moffitt-green.mh3.pv1.ph4.o-40[
x_range <- max(x) - min(x)
...
.f1.mt4.pa4.code[
verb <- .dark-gray[function(].moffitt-bg-blue.moffitt-blue.pa3[x, y = 0, ...]) {  
.moffitt-bg-green-o20.moffitt-green.mh3.pv1.ph4[
x_range <- max(x) - min(x)
...
.f1.mt4.pa4.code[
verb <- .dark-gray[function(].moffitt-bg-blue-o20.moffitt-blue.pa3[x, y = 0, ...]) {  
.moffitt-bg-green-o20.moffitt-green.mh3.pv1.ph4[
...
.f1.mt4.pa4.code.moffitt-bg-grey-o20[
verb <- .dark-gray[function(].moffitt-bg-blue.moffitt-blue.pa3.o-30[x, y = 0, ...]) {  
.moffitt-bg-green.moffitt-green.mh3.pv1.ph4.o-50[
x_range <- max(x) - min(x)
...
.f1.mt4.pa4.code.moffitt-bg-grey-o20[
scale <- .dark-gray[function(].moffitt-bg-blue-o20.moffitt-blue.pa3[x, y = 0, ...]) {  
.moffitt-bg-green-o20.moffitt-green.mh3.pv1.ph4[
x_range <- max(.moffitt-blue[x]) - min(.moffitt-blue[x])
...
.f1.mt4.pa4.code.moffitt-bg-grey-o20[
scale <- .dark-gray[function(].moffitt-bg-blue-o20.moffitt-blue.pa3[x, y = 0, .moffitt-red[...]]) {  
.moffitt-bg-green-o20.moffitt-green.mh3.pv1.ph4[
...
* Your friend is Canadian and keeps sharing their local whether in &deg;C.
...
.footnote[
Jenny Bryan: [Lazy Evaluation](https://resources.rstudio.com/rstudio-conf-2019/lazy-evaluation), rstudio::conf  
...
```{r}
make_rgba <- function(hex, alpha = 1) {
  rgb <- t(col2rgb(hex))
  rgb_string <- paste(rgb, collapse = ", ")
  paste0("rgba(", rgb_string, ", ", alpha, ")")
}
```
