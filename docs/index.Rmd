...
background-image: url(assets/images/bench-accounting-xxeAftHHq6E-unsplash.webp)
background-size: 100%
...
![](assets/images/drake_meme.webp)

---

```{r messy-data-workflow, echo=FALSE, results="asis"}
messy_slides <- dir("assets/images/drawn", pattern = "messy.+.webp$", full.names = TRUE)
...
class: middle
background-image: url('assets/images/drawn/messy-workflow-32.webp')
background-size: contain
...
proj_slides <- dir("assets/images/drawn", pattern = "project.+.webp$", full.names = TRUE)
...
drake_intro <- dir("assets/images/drawn", pattern = "drake-intro-\\d+[.].webp$", full.names = TRUE)
